    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top"
                ><span class="d-block d-lg-none">Daniel Rocha</span><span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="https://avatars3.githubusercontent.com/u/25344661?v=4" alt="Daniel Rocha" /></span></a
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Federal Agricultural Inspector</h3>
                            <div class="subheading mb-3">Ministry of Agriculture, Livestock and Food Supply</div>
                            <p>Inps. Positions held at Amazonas, São Paulo and Rio de Janeiro States</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">Jun 2005 - Present</span></div>
                    </div>
                </div>    
            </section> -->
            <hr class="m-0" />
...
<!--             <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Federal Fluminense University</h3>
                            <div class="subheading mb-3">Bachelor Degree</div>
                            <div>Technology in Computer Systems</div>
                            <!--<p>GPA: x.xx</p>-->
                        </div>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Federal University of Viçosa</h3>
                            <div class="subheading mb-3">Master Degree in Plant Protection</div>
                            <!--<p>GPA: x.xx3</p>-->
                            <div> Identification of risk profile associated with imported consignments with likelihood to host quarantine pests.  <a href="https://www.locus.ufv.br/handle/123456789/5865">Abstract</a>
                            </div>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">2011 - 2013</span></div>
                    </div>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Federal University of Viçosa</h3>
                            <div class="subheading mb-3">Specialization in Plant Protection</div>
                            <!--<p>GPA: x.xx3</p>-->
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">2006 - 2006</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Federal University of Viçosa</h3>
                            <div class="subheading mb-3">Bachelor Degree in Agronomy</div>
                            <!--<p>GPA: x.xx3</p>-->
                        </div>
...
<!--             <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    ...
                    <p>I am interested in music and tennis. I spend part of my free time learning and sharing experiences with my three-year-old daughter.</p>                    
                </div>
            </section> -->
            <hr class="m-0" />
            <!-- Awards-->
